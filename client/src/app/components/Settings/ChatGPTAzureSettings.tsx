		...
		<div className="flex flex-col gap-3">
			<div className="flex flex-col gap-1">
				...
				<Input
					...
					onChange={(e) =>
						updateConfigValue({
							azureOpenAIApiInstanceName: e.currentTarget.value.trim(),
						})
					}
				/>
			</div>
			<div className="flex flex-col gap-1">
				...
				<Input
					...
					onChange={(e) =>
						updateConfigValue({
							azureOpenAIApiKey: e.currentTarget.value.trim(),
						})
					}
					type="password"
				/>
			...
			<div className="flex flex-col gap-1">
				...
				<Input
					...
					onChange={(e) =>
						updateConfigValue({
							azureOpenAIApiDeploymentName: e.currentTarget.value.trim(),
						})
					}
				/>
			</div>
